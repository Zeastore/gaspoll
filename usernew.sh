...
echo -e "==============================="
echo -e "Informasi All Port"
echo -e "==============================="
echo -e "OpenSSH     : 22"
echo -e "Dropbear    : 109, 143"
echo -e "WS TLS      : 443"
echo -e "WS None TLS : 2082"
echo -e "WS OVPN     : 2086"
...
echo -e "http://${domain}:89/client-tcp-$ovpn.ovpn"
echo -e "http://${domain}:89/client-udp-$ovpn2.ovpn"
echo -e "http://${domain}:89/client-tcp-ssl.ovpn"
echo -e "==============================="
echo -e "Created  : $created"
echo -e "Expired   : $exp"
echo -e "==============================="
echo -e ""
echo -e "AutoScript By ZEASTORE"
echo -e ""
